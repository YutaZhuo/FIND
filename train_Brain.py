...
dataset_opt = {"dataroot": "../datasets/brain_combine",
               "batch_size": 4,
               "use_shuffle": True,
               "num_workers": 4,
...
def main(args):
    ...
    dataset = Data.create_dataset_Brain(dataroot=dataset_opt["dataroot"],
    ...
    for curr_epoch in range(1, args.epochs + 1):
        for istep, train_data in enumerate(train_loader, start=1):
            ...
            if record_cnter == 1 or record_cnter % args.val_freq == 0:
                ...
                with torch.no_grad():
                    dataset = Data.create_dataset_Brain(dataroot="../datasets/brain_combine",
                                                        finesize=dataset_opt["finesize"],
                                                        phase="val")
